...
% %x1
% harmonic_coefficients(2, :) = [0.14   0 0.187   0];
% harmonic_coefficients(3, :) = [0.949   0.1 0.613   0.335]; % Initial values for the first-order harmonics

%% 
% % period -2
% load parameter_alpha_0.8_alpha1_1.5_x2_single.mat;

load matlab_green_alpha1_1.mat;
