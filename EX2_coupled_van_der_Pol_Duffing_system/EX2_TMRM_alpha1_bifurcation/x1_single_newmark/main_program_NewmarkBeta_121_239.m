...
num_harmonics = 25;
index_bifurcation=1;
% for alpha1=1.24:0.001:1.428
x(1,1)=1;dx(1,1)=0.5;ddx(1,1)=0;
x(2,1)=0.5;dx(2,1)=0.5;ddx(2,1)=0;
for alpha1=1.121:0.001:1.239
    alpha1
...
save('x1_num_xcal_1.121_1.239.mat', 'num_xcal','-v7.3');
