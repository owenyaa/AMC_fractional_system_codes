...
% %x1
% % harmonic_coefficients(2, :) = [0.29   0 0.3867   0];
% % harmonic_coefficients(3, :) = [-0.0778   -0.08 -0.117   -0.689]; % Initial values for the first-order harmonics
load para_alpha_0.8_period_2.mat;
harmonic_coefficients(1, 1) = harmonic_coefficients(1, 1);
