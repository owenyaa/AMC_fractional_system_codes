...
%% 计算残差
residual=calculate_residual_even(parameter_a);
%% 绘制残差曲线
% figure;
...
% 
%     residual1=calculate_residual_even(parameter_a);
...
for i=1:1:num_degrees_freedom
    ...
    aaaa=(residual1-residual)/ddt;
    figure;
    plot(time_data,residual(:,(num_degrees_freedom+1)*(2 * num_harmonics * num_degrees_freedom+i+1)+1),'r-')
    hold on
    plot(time_data,residual(:,(num_degrees_freedom+1)*(2 * num_harmonics * num_degrees_freedom+i+1)+2),'r-')
    hold on
    plot(time_data,residual(:,(num_degrees_freedom+1)*(2 * num_harmonics * num_degrees_freedom+i+2)),'r-')
    hold on
