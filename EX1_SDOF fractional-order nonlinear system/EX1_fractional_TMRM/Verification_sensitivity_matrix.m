...
clc;clear;%close all;
global total_time step_size
global num_degrees_freedom num_harmonics time_data
global alpha nonliear_stiffness_matrix mass_matrix epsilon omega
%% parameters
mass_matrix=1; nonliear_stiffness_matrix=1;
epsilon=-0.8;alpha=0.5; omega=1;
w0=0.681669691477223;
num_degrees_freedom=1;num_harmonics=3;
...
parameter_a(1,1)=w0;
% parameter_a(2, 1) = 0.342172594555505;parameter_a(2, 3) = 0.342172594555505;
parameter_a(2:end,:)=[C0_1,S0_1];   % 6行2列
